...
class Login extends Component {
  ...
  render() {
    ...
    return (
        <div style ={ { backgroundImage: "url('http://users.metropolia.fi/~joonaesa/pics/login.jpg')", width: "100vw", height: "100vh", backgroundSize: "cover", backgroundRepeat: "no-repeat"} }>
